...
private Set<BatchTrainer> batchTrainers = new LinkedHashSet<>();

public Set<BatchTrainer> getBatchTrainers() {
    return batchTrainers;
}

public void setBatchTrainers(Set<BatchTrainer> batchTrainers) {
