...
public interface PersonRepository extends JpaRepository<Person, Long> {	 
 ...
 @Query("SELECT e.student.id FROM Enrollment e WHERE e.batch.id = :batchId")
    List<Integer> findAllParticipantIdsByBatchId(@Param("batchId") Integer batchId);

    @Query("SELECT e.student.id FROM Enrollment e WHERE e.batch.id = :batchId AND e.role = :role")
    List<Integer> findAllLinkedIdsByBatchIdAndRole(@Param("batchId") Integer batchId, @Param("role") String role);
